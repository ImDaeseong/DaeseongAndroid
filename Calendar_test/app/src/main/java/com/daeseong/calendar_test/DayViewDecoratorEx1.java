...
public class DayViewDecoratorEx1 implements DayViewDecorator {
    ...
    private static final String TAG = DayViewDecoratorEx1.class.getSimpleName();

    private final Calendar calendar;

    public DayViewDecoratorEx1(){
    ...
    public void decorate(DayViewFacade view) {
        view.addSpan(new ForegroundColorSpan(Color.rgb(0, 255, 0)));
