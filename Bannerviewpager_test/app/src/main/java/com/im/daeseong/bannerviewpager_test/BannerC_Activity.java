...
public class BannerC_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banner_c_);

        rLayout = (RelativeLayout) findViewById(R.id.mBannerView);
        pagerAdapter = new BannerAdapter(getApplicationContext(), imgs);
        bannerView = new BannerView(getApplicationContext(), imgs, pagerAdapter,R.layout.widget_banner_c_view);
