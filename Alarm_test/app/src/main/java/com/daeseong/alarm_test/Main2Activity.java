...
public class Main2Activity extends AppCompatActivity {
    ...
    private void  setAlaram(){
        ...
        alarmpendingIntent = PendingIntent.getBroadcast(Main2Activity.this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void DestroyAlarm(){
        ...
        if(alarmpendingIntent != null) {
            alarmpendingIntent = PendingIntent.getBroadcast(Main2Activity.this,0, alarmIntent, PendingIntent.FLAG_CANCEL_CURRENT);
