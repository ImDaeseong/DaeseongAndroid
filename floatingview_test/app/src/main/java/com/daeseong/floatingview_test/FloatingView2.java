...
public class FloatingView2 {

    private View floatingview, cLClose;
    private TextView tv1, tv2;

    public FloatingView2(ViewGroup viewGroup) {

        floatingview = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.floating_layout2, viewGroup, false);
