...
public class Popup3Activity extends AppCompatActivity {

    private static final String TAG = Popup3Activity.class.getSimpleName();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (nCurrentPopupY >= nloadPopupY && nCurrentPopupY <= nLimit) {
