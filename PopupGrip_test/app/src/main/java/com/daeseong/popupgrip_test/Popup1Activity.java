...
public class Popup1Activity extends AppCompatActivity {
    ...
    private static final String TAG = Popup1Activity.class.getSimpleName();
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if ((popup_layout.getY() - nStartPopupY) > (nLimit / 2)) {
                            ...
                            // 아래로 슬라이딩하면서 종료
                            popup_layout.animate().y(popup_layout.getHeight()).setDuration(200).withEndAction(new Runnable() {
                                @Override
                                public void run() {
                            ...
                            // 팝업창 시작 위치로 되돌리기
                            popup_layout.animate().y(nStartPopupY).setDuration(200).start();
