    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.button3:
                ...
                break;
            case R.id.button4:
                startActivity(new Intent(this, Button4Activity.class));
                break;
            case R.id.button5:
                startActivity(new Intent(this, Button5Activity.class));
                break;
            case R.id.button6:
                startActivity(new Intent(this, Button6Activity.class));
                break;
        }
    }
}
